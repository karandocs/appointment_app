...
Swaggard.configure do |config|
  ...
  # config.use_cache = false
    ...
    # config.authentication_value = '' # Initial value for authentication. Defaults to ''
    config.additional_parameters = [{ key: 'client', type: 'header', value: '' }, { key: 'Content-Type', type: 'header', value: 'text/plain' }, { key: 'access-token', type: 'header', value: '' }, { key: 'uid', type: 'header', value: '' }, { key: 'expiry', type: 'header', value: '' }, { key: 'accept', type: 'header', value: 'application/json' }]
end
